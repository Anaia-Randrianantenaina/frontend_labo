...
export default function AjoutAnalyseEx({ mipoitra, tsymikatona }) {
    //afahana mana  o modal
    if (!mipoitra) return null
        ...
        <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
            <form>
                <div className="bg-white w-[720px] h-[550px] rounded">
                    <button className="bg-white w-6 h-6 rounded-sm mt-1 mx-[690px] text-red-600 text-[18px] font-semibold hover:bg-slate-100 transition duration-100" onClick={() => tsymikatona()}>X</button>
                    ...
                    <div className="mt-5">
                        <div>
                            {/* PATIENT */}
                            <p className="flex ml-9 font-semibold"><IoMdInformationCircleOutline className="mt-1 ml-1 mr-1" /> Information du patient externe</p>
                            ...
                            <TextField id="outlined-basic" label="Adresse" variant="outlined" className="mt-2 ml-5 w-[200px]" disabled />
                            ...
                            <Button onClick={() => tsymikatona()} className="text-white bg-green-800 hover:bg-green-700 float-right mr-[285px] mt-5 w-[150px] h-[35px]">
